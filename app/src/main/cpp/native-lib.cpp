...
Java_songpatechnicalhighschool_motivation_opencvwithcmake2_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance, jlong matAddrInput,jlong matAddrResult){
...
Java_songpatechnicalhighschool_motivation_opencvwithcmake2_MainActivity_loadCascade(JNIEnv *env, jobject instance, jstring cascadeFileName_) {
...
extern "C" JNIEXPORT void JNICALL
Java_songpatechnicalhighschool_motivation_opencvwithcmake2_ImageActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance, jlong matAddrInput,jlong matAddrResult){
    Mat &matInput = *(Mat *)matAddrInput;
    Mat &matResult = *(Mat *)matAddrResult;
    cvtColor(matInput, matResult, COLOR_RGBA2GRAY);
}
...
extern "C"
JNIEXPORT jlong JNICALL
Java_songpatechnicalhighschool_motivation_opencvwithcmake2_ImageActivity_loadCascade(JNIEnv *env, jobject instance, jstring cascadeFileName_) {
